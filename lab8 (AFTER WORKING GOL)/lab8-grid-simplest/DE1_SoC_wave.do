...
add wave -noupdate /DE1_SoC_testbench/grid_initial
add wave -noupdate /DE1_SoC_testbench/GrnPixels
add wave -noupdate /DE1_SoC_testbench/RedPixels
add wave -noupdate /DE1_SoC_testbench/RedPixels_next
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {14091 ps} 0}
...
update
WaveRestoreZoom {13859 ps} {17955 ps}
